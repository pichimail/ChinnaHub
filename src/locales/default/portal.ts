export default {
  ...
  'artifacts.download.html': 'Download .html',
  'artifacts.download.jsx': 'Download .jsx',
  'artifacts.download.nextjs': 'Download Next.js .zip',
  'artifacts.download.setup': 'Copy VS Code setup command',
  'artifacts.download.setupCopied': 'Setup command copied',
  'artifacts.download.title': 'Download',
  'artifacts.download.tsx': 'Download .tsx',
