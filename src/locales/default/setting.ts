export default {
  ...
  'creds.file.authRequired': 'Please sign in to ChinnaHub Connect first',
  ...
  'creds.signIn': 'Sign in to ChinnaHub Connect',
  'creds.signInRequired': 'Please sign in to ChinnaHub Connect to manage your credentials',
  ...
  'myAgents.errors.notAuthenticated': 'Please sign in to ChinnaHub Connect first',
  'myAgents.loginRequired.button': 'Sign in to ChinnaHub Connect',
  'myAgents.loginRequired.description':
    'Please sign in to ChinnaHub Connect to view your published agents',
