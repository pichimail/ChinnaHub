export default {
  ...
  'remoteServer.configDesc':
    'Connect to the remote ChinnaHub server to enable data synchronization',
  ...
  'sync.chinnahubCloud.description': 'Official ChinnaHub cloud version',
  'sync.chinnahubCloud.title': 'ChinnaHub Cloud',
