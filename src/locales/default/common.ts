export default {
  ...
  'agentOnboardingPromo.description':
    'Set up your agent teams in a quick chat with Chinna. Your existing agents remain unchanged.',
  ...
  'messengerBanner.title': 'Talk to Chinna AI on your favorite messaging apps',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use ChinnaHub Cloud.',
  ...
  'promptAssistant.actions.enhance': 'Enhance Prompt',
  'promptAssistant.actions.generate': 'Generate Prompt',
  'promptAssistant.status.enhancing': 'Enhancing prompt...',
  'promptAssistant.status.generating': 'Generating prompt...',
